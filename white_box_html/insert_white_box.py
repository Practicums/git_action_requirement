...
import argparse
soup = BeautifulSoup(open('git_action_requirement/white_box_test_html/test_changed.html').read(), 'html.parser')
...
node.insert(0, soup2)
f = open("git_action_requirement/white_box_test_html/test_changed.html", "w").write(str(soup))
